...
const userId = 'test-user-1'; // Hardcoded for now
    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="mb-6 p-4 border rounded-lg space-y-2">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={createTask} className="bg-blue-600 text-white px-4 rounded">Add Task</button>
        </div>
      </div>
          ...
          <div key={task.id} className="p-4 border rounded flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Urgency: {task.urgency} | Priority: {task.priority} | Status: {task.status}
              </p>
            </div>
